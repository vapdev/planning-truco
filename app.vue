    ...
    <div class="w-full grid grid-cols-3">
        ...
        <template v-if="jogoComecou && jogadorLogado.admin">
          <div class="flex flex-col gap-4">
            <div class="flex gap-2">
              <div
                @click="virarAutomatico = !virarAutomatico"
            ...
            <div v-if="!virarAutomatico" class="text-red-500">
              <button
                @click="mostrarCartas = !mostrarCartas"
                class="text-white font-bold py-2 px-4 rounded"
                :class="mostrarCartas ? 'bg-red-500 hover:bg-red-700' : 'bg-green-500 hover:bg-green-700'"
              >
      ...
      <div class="flex-grow flex-col flex gap-2">
        ...
        <div v-if="jogoComecou" class="flex justify-end">
          ...
          <button
            @click="sairDaSala"
            class="bg-red-500 w-40 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
          >
            Sair da sala
          </button>
        </div>
        <div class="flex justify-end h-10">
          <input
            v-model="nome"
            class="border-2 border-green-500 w-40 rounded pl-2"
      ...
      <div class="w-full flex justify-center gap-10">
        ...
        >
          <div
            ...
            "
          >
            <span v-if="mostrarCartas && player.votou" class="text-5xl flex justify-center">{{
              player.score
            }}</span>
          </div>
          <div>
      ...
      <div class="w-full flex justify-center gap-4">
        ...
        >
          <div
            ...
            :class="
              selectedCard == card.number ? card.class + ' -translate-y-10' : card.class
            "
