<template>
  <div :key="key"
    class="game-wrapper game-room-mobile atkinson-hyperlegible-mono-regular min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900 text-white relative overflow-y-auto">
