        ...
        <header class="relative w-full h-24">
            <div
                ...
                <a href="/" class="relative flex items-center inline-block h-5 h-full font-black leading-none">
                    ...
                    <span id="home" class="ml-3 text-xl text-gray-800">Free Planning Poker<span class="text-pink-500">.</span></span>
                </a>
                ...
                <nav id="nav" :class="{ hidden: !isNavOpen }"
                    ...
                    <a href="#features"
                        class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Recursos</a>
                    <!-- <a href="#pricing"
                        class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Preços</a>
                    <a href="#testimonials"
                        class="font-bold duration-100 transition-color hover:text-indigo-600">Depoimentos</a> -->
                ...
                <div 
                    class="absolute z-[42] left-0 flex-col items-center justify-center hidden w-full pb-8 mt-48 border-b border-gray-200 md:relative md:w-auto md:bg-transparent md:border-none md:mt-0 md:flex-row md:p-0 md:items-end md:flex md:justify-between">
                    <!-- <a href="#_"
...
nav                        class="relative z-40 inline-block w-auto h-full px-5 py-3 text-sm font-bold leading-none text-white cursor-pointer transition-all transition duration-100 duration-300 bg-indigo-700 rounded shadow-md fold-bold lg:bg-white lg:text-indigo-700 sm:w-full lg:shadow-none hover:shadow-xl">Iniciar agora</a>
                ...
                <div @click="toggleNav" :class="{ close: isNavOpen }" id="nav-mobile-btn"
        ...
        <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
            <div
                ...
                <div
                    class="z-[51] flex flex-col items-center w-full max-w-xl pt-48 text-center lg:items-start lg:w-1/2 lg:pt-20 xl:pt-40 lg:text-left">
                    ...
                    <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">
                        O Free Planning Poker é uma ferramenta para auxiliar times ágeis a estimar o esforço de
                        desenvolvimento de suas tarefas.
                    </p>
                    <a href="#_"
                        @click="startGame"
                        class="relative self-start inline-block w-auto px-8 py-4 mx-auto mt-0 text-base font-bold text-white bg-indigo-600 border-t border-gray-200 rounded-md shadow-xl sm:mt-1 fold-bold lg:mx-0">Iniciar agora!</a>
        ...
        <div id="features"
            ...
            <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
                <h2 class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">recursos da plataforma</h2>
                <h3
                    class="max-w-2xl px-5 mt-2 text-3xl font-black leading-tight text-center text-gray-900 sm:mt-0 sm:px-0 sm:text-6xl">
                    Porque utilizar o Free Planning Poker</h3>
                            ...
                            <div class="overflow-hidden text-black bg-white rounded-lg shadow-lg shadow-inner">
                                <div
                                    ...
                                    <h3 class="p-3 pb-1 text-lg font-bold tracking-wide text-center uppercase">
                                        Premium<span class="ml-2 font-light">Plan</span></h3>
                                    <h4
                                        class="flex items-center justify-center pb-6 text-4xl font-bold text-center text-gray-900">
            ...
            <div class="max-w-6xl mx-auto">
                <div class="flex-col items-center ">
                    <div
                        ...
                        <p class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">Our customers
                            love
                            our product
                        </p>
                        <h2
        ...
        <footer class="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
            <div class="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
                <div class="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
                    ...
                    <p class="mt-6 mr-4 text-base text-gray-500">Criando soluções para facilitar a vida dos
                        profissionais de TI.
                    </p>
                </div>
                <div class="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
                    <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                        <li class="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                            Produto</li>
                        <li><a href="#home"
                                class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Início</a>
                        </li>
                        <li><a href="#features"
                                class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Recursos</a>
                        </li>
                    </ul>
                    <!-- Integrates with section -->
                    <div class="flex-col hidden sm:flex">
                        <p class="mb-4 text-sm font-medium tracking-widest text-gray-500 uppercase">Criado por</p>
                        <div class="flex" @click="redirectToGithub">
                            ...
                            <div  class="text-gray-500 items-center flex cursor-pointer">
                                Vapdev
                            </div>
                        </div>
                    </div>
                    <!-- <div class="flex flex-col w-full text-gray-700">
                        <div class="inline-block px-3 py-2 mt-5 font-bold text-gray-800 uppercase md:mt-0">Nos siga
                        </div>
            ...
            <div class="pt-4 pt-6 mt-10 text-center text-gray-500 border-t border-gray-100">© 2024 Vapdev. Todos os direitos reservados.
            </div>
        </footer>
            ...
            <div class="relative rounded-lg rubik-font font-bold bg-[#3f4146] p-12 flex flex-col gap-6">
                ...
                <div class="text-md flex flex-col gap-4 text-white">
                    ...
                    <div class="flex text-white w-full gap-4">
                        <UInput v-model="roomName" size="lg" color="blue" variant="outline" inputClass="text-white" class="w-full text-white"
